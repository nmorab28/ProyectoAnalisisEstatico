...
public class PanelLlano extends JPanel {
	...
	public PanelLlano(ActionListener listener) {
		setLayout(null);
		...
		btnSalir.setActionCommand("BOTON_EXIT_LLANO");
		add(btnSalir);

		fondoVentana = new JLabel();
		fondoVentana.setSize(1000, 620);
		ImageIcon icono = new ImageIcon("Imagenes/carreraLlano.png");
