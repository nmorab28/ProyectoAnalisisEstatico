 ...
 */
public class DirectorDTO extends Usuario implements Serializable {
     ...
     */
    public DirectorDTO(String nombre, String id, String genero, String correo, String usuario, String contrasena, String experiencia) {
        // Llamada al constructor de la superclase Usuario
