...
/**
 * La clase EscaladorDTO representa un ciclista especializado en escalar pendientes.
 * Hereda de la clase Ciclista y agrega los atributos aceleración promedio y grado de la rampa.
 */
public class EscaladorDTO extends Ciclista implements Serializable {
     ...
     */
    public EscaladorDTO(String nombre, String id, String genero, String correo, String usuario, String contrasena,
